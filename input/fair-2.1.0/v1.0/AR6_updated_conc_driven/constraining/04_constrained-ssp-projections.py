...
for irow in range(15):
    ...
    if scenmap==4:
        scenmap=7
    temp_matrix_19952014[irow, :] = (np.percentile(np.average(f.temperature[periodmap[irow%3], scenmap, :, 0], weights=weight_20yr, axis=0)-np.average(f.temperature[245:266, scenmap, :, 0], weights=weight_20yr, axis=0), (5, 50, 95))
    temp_matrix_18501900[irow, :] = (np.percentile(np.average(f.temperature[periodmap[irow%3], scenmap, :, 0], weights=weight_20yr, axis=0)-np.average(f.temperature[100:151, scenmap, :, 0], weights=weight_51yr, axis=0), (5, 50, 95))

temp_target_19952014 = np.array(
    [
        [0.38, 0.61, 0.85],
        [0.40, 0.71, 1.07],
        [0.24, 0.56, 0.96],
...
print()
print((temp_model_19952014-temp_target_19952014)/temp_target_19952014)
...
pl.legend()
pl.xlim(1750,2020)
#pl.savefig('../plots/co2_historical.png')
pl.show()
