...
params_out.columns = ['gamma', 'c1', 'c2', 'c3', 'kappa1', 'kappa2', 'kappa3', 'epsilon',
       ...
       'ari Equivalent effective stratospheric chlorine', 'shape Sulfur',
       'shape BC', 'shape OC', 'beta', 'o3 CH4', 'o3 N2O',
       'o3 Equivalent effective stratospheric chlorine', 'o3 CO', 'o3 VOC', 'o3 NOx',
       'scale CH4', 'scale N2O', 'scale minorGHG', 'scale Stratospheric water vapour',
       'scale Contrails', 'scale Light absorbing particles on snow and ice', 'scale Land use',
       'scale Volcanic', 'solar_amplitude', 'solar_trend', 'scale CO2', 'co2_concentration_1750', 'seed']
