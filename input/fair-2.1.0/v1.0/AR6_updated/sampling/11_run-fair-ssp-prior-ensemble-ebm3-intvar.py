...
if __name__ == "__main__":
    ...
    for ibatch, batch_start in enumerate(range(0, samples, batch_size)):
        ...
        config[ibatch]['CO2_1750'] = df_1750co2.loc[batch_start:batch_end-1, 'co2_concentration'].values.squeeze()
    ...
    for ibatch, batch_start in enumerate(range(0, samples, batch_size)):
        ...
        fo3_out[batch_start:batch_end] = res[ibatch][5]
        ecs[batch_start:batch_end] = res[ibatch][6]
        tcr[batch_start:batch_end] = res[ibatch][7]
