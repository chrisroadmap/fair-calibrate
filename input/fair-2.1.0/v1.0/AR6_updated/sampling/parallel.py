...
def run_fair(cfg):
    ...
    fill(
        f.forcing,
        cfg['volcanic_forcing'][:, None, None] * cfg["scaling_Volcanic"], specie='Volcanic'
    )
    fill(f.forcing,
    ...
    fill(f.climate_configs['ocean_heat_transfer'], np.array([cfg['kappa1'], cfg['kappa2'], cfg['kappa3']]).T)
    ...
    fill(f.species_configs['forcing_scale'], cfg['scaling_contrails'], specie='Stratospheric water vapour')
    ...
    fill(f.species_configs['erfari_radiative_efficiency'], cfg['ari_Sulfur'], specie='Sulfur')
    fill(f.species_configs['erfari_radiative_efficiency'], cfg['ari_VOC'], specie='VOC')
    fill(f.species_configs['erfari_radiative_efficiency'], cfg['ari_EESC'], specie='Equivalent effective stratospheric chlorine')

    # Ozone
    fill(f.species_configs['ozone_radiative_efficiency'], cfg['ozone_CH4'], specie='CH4')
    fill(f.species_configs['ozone_radiative_efficiency'], cfg['ozone_N2O'], specie='N2O')
    fill(f.species_configs['ozone_radiative_efficiency'], cfg['ozone_CO'], specie='CO')
    fill(f.species_configs['ozone_radiative_efficiency'], cfg['ozone_VOC'], specie='VOC')
    fill(f.species_configs['ozone_radiative_efficiency'], cfg['ozone_NOx'], specie='NOx')
    fill(f.species_configs['ozone_radiative_efficiency'], cfg['ozone_EESC'], specie='Equivalent effective stratospheric chlorine')
    ...
    return (
        ...
        f.forcing[269:271, 0, :, 58].mean(axis=0),
        f.ebms.ecs,
        f.ebms.tcr
    )
