...
fari_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/forcing_ari_2005-2014_mean.npy')
faci_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/forcing_aci_2005-2014_mean.npy')
co2_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/concentration_co2_2014.npy')
ecs_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/ecs.npy')
tcr_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/tcr.npy')
#ssp_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/temperature_ssp_future.npy')
af_in = np.load(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_runs/airborne_fraction_1pctCO2_y70_y140.npy')
...
# SSP119 2021-40, 2041-60, 2081-2100
#In [5]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.38, 0.61, 0.85), options={'maxfev': 5000}).x
#In [6]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.4, 0.71, 1.07), options={'maxfev': 5000}).x
#In [7]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.24, 0.56, 0.96), options={'maxfev': 5000}).x

# SSP126
#In [8]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.41, 0.63, 0.89), options={'maxfev': 5000}).x
#In [9]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.54, 0.88, 1.32), options={'maxfev': 5000}).x
#In [10]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.51, 0.90, 1.48), options={'maxfev': 5000}).x

# SSP245
#In [11]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.44, 0.66, 0.90), options={'maxfev': 5000}).x
#In [12]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.78, 1.12, 1.57), options={'maxfev': 5000}).x
#In [13]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (1.24, 1.81, 2.59), options={'maxfev': 5000}).x

# SSP370
#In [14]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.45, 0.67, 0.92), options={'maxfev': 5000}).x
#In [15]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.92, 1.28, 1.75), options={'maxfev': 5000}).x
#In [16]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (2.00, 2.76, 3.75), options={'maxfev': 5000}).x

# SSP585
#In [17]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (0.51, 0.76, 1.04), options={'maxfev': 5000}).x
#In [18]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (1.08, 1.54, 2.08), options={'maxfev': 5000}).x
#In [19]: scipy.optimize.root(opt, (2.0, 2.6, 1.2), (2.44, 3.50, 4.82), options={'maxfev': 5000}).x

#Out[5]: array([0.77977365, 0.53137535, 0.16400778])
#Out[6]: array([1.3740861 , 0.54699743, 0.26691752])
#Out[7]: array([1.73098951, 0.36502304, 0.30357142])
#Out[8]: array([1.45888998, 0.50961055, 0.19411005])
#Out[9]: array([1.90511412, 0.6609226 , 0.33627178])
#Out[10]: array([2.72752308, 0.5987129 , 0.44964454])
#Out[11]: array([1.05577355, 0.56424091, 0.17165765])
#Out[12]: array([2.0223254 , 0.89351592, 0.34515188])
#Out[13]: array([2.20496701, 1.4124379 , 0.60080822])
#Out[14]: array([1.2675395 , 0.56057809, 0.18348518])
#Out[15]: array([1.95052817, 1.0449382 , 0.35973319])
#Out[16]: array([1.93890083, 2.26541737, 0.75745677])
#Out[17]: array([1.19455964, 0.64079022, 0.20386372])
#Out[18]: array([1.42648205, 1.29198324, 0.40213528])
#Out[19]: array([1.7123891 , 2.85832229, 1.00089791])
samples = {}
...
samples['OHC'] = scipy.stats.norm.rvs(loc=396/0.91, scale=67/0.91, size=10**5, random_state=43178)
...
#samples['ssp119 2021-2040'] = scipy.stats.skewnorm.rvs(0.77977365, loc=0.53137535, scale=0.16400778, size=10**5, random_state=131692)
#samples['ssp126 2021-2040'] = scipy.stats.skewnorm.rvs(1.45888998, loc=0.50961055, scale=0.19411005, size=10**5, random_state=3791)
#samples['ssp245 2021-2040'] = scipy.stats.skewnorm.rvs(1.05577355, loc=0.56424091, scale=0.17165765, size=10**5, random_state=8016935)
#samples['ssp370 2021-2040'] = scipy.stats.skewnorm.rvs(1.2675395, loc=0.56057809, scale=0.18348518, size=10**5, random_state=173048)
#samples['ssp585 2021-2040'] = scipy.stats.skewnorm.rvs(1.19455964, loc=0.64079022, scale=0.20386372, size=10**5, random_state=3373061)
#
#samples['ssp119 2041-2060'] = scipy.stats.skewnorm.rvs(1.3740861, loc=0.54699743, scale=0.26691752, size=10**5, random_state=1316924)
#samples['ssp126 2041-2060'] = scipy.stats.skewnorm.rvs(1.90511412, loc=0.6609226, scale=0.33627178, size=10**5, random_state=37915)
#samples['ssp245 2041-2060'] = scipy.stats.skewnorm.rvs(2.0223254, loc=0.89351592, scale=0.34515188, size=10**5, random_state=80169358)
#samples['ssp370 2041-2060'] = scipy.stats.skewnorm.rvs(1.95052817, loc=1.0449382, scale=0.35973319, size=10**5, random_state=1730489)
#samples['ssp585 2041-2060'] = scipy.stats.skewnorm.rvs(1.42648205, loc=1.29198324, scale=0.40213528, size=10**5, random_state=33730619)
#
#samples['ssp119 2081-2100'] = scipy.stats.skewnorm.rvs(1.73098951, loc=0.36502304, scale=0.30357142, size=10**5, random_state=13169246)
#samples['ssp126 2081-2100'] = scipy.stats.skewnorm.rvs(2.72752308, loc=0.5987129, scale=0.44964454, size=10**5, random_state=379158)
samples['ssp245 2081-2100'] = scipy.stats.skewnorm.rvs(2.20496701, loc=1.4124379, scale=0.60080822, size=10**5, random_state=801693589)
#samples['ssp370 2081-2100'] = scipy.stats.skewnorm.rvs(1.93890083, loc=2.26541737, scale=0.75745677, size=10**5, random_state=17304893)
#samples['ssp585 2081-2100'] = scipy.stats.skewnorm.rvs(1.7123891, loc=2.85832229, scale=1.00089791, size=10**5, random_state=337306191)
...
for constraint in [
    ...
    'ERFaer', 
    'CO2 concentration', 
    #'ssp119 2021-2040', 'ssp126 2021-2040', 'ssp245 2021-2040', 'ssp370 2021-2040', 'ssp585 2021-2040', 'ssp119 2041-2060', 'ssp126 2041-2060', 'ssp245 2041-2060', 'ssp370 2041-2060', 'ssp585 2041-2060', 'ssp119 2081-2100', 'ssp126 2081-2100', 
    'ssp245 2081-2100',
    #'ssp370 2081-2100', 'ssp585 2081-2100'
]:
...
accepted = pd.DataFrame(
    {
        ...
        'ssp245 2081-2100': np.average(temp_in[231:252,valid_temp], weights=weights_20yr, axis=0) - np.average(temp_in[145:166,valid_temp], weights=weights_20yr, axis=0)
#        'ssp119 2021-2040': ssp_in[0, 0, :], # future SSPs are only run with RMSE constrained set
#        'ssp119 2041-2060': ssp_in[1, 0, :],
#        'ssp119 2081-2100': ssp_in[2, 0, :],
#        'ssp126 2021-2040': ssp_in[0, 1, :],
#        'ssp126 2041-2060': ssp_in[1, 1, :],
#        'ssp126 2081-2100': ssp_in[2, 1, :],
#        'ssp245 2021-2040': ssp_in[0, 2, :],
#        'ssp245 2041-2060': ssp_in[1, 2, :],
#        'ssp245 2081-2100': ssp_in[2, 2, :],
#        'ssp370 2021-2040': ssp_in[0, 3, :],
#        'ssp370 2041-2060': ssp_in[1, 3, :],
#        'ssp370 2081-2100': ssp_in[2, 3, :],
#        'ssp585 2021-2040': ssp_in[0, 4, :],
#        'ssp585 2041-2060': ssp_in[1, 4, :],
#        'ssp585 2081-2100': ssp_in[2, 4, :],
    },
    index=valid_temp
)
...
prior_temp = scipy.stats.gaussian_kde(np.average(temp_in[145:166,:], weights=weights_20yr, axis=0) - np.average(temp_in[:52,:], weights=weights_51yr, axis=0))
post1_temp = scipy.stats.gaussian_kde(np.average(temp_in[145:166,valid_temp], weights=weights_20yr, axis=0) - np.average(temp_in[:52,valid_temp], weights=weights_51yr, axis=0))
...
prior_ssp = scipy.stats.gaussian_kde(np.average(temp_in[231:252, :], weights=weights_20yr, axis=0) - np.average(temp_in[145:166, :], weights=weights_20yr, axis=0))
post1_ssp = scipy.stats.gaussian_kde(np.average(temp_in[231:252,valid_temp], weights=weights_20yr, axis=0) - np.average(temp_in[145:166,valid_temp], weights=weights_20yr, axis=0))
...
if plots:
    ...
    start = -1.0
    stop = 0.3
    ax[1,0].plot(np.linspace(start, stop, 1000), target_ari(np.linspace(start, stop, 1000)), color=colors['target'], label='Target')
    ax[1,0].plot(np.linspace(start, stop, 1000), prior_ari(np.linspace(start, stop, 1000)), color=colors['prior'], label='Prior')
    ax[1,0].plot(np.linspace(start, stop, 1000), post1_ari(np.linspace(start, stop, 1000)), color=colors['post1'], label='Temperature RMSE')
    ax[1,0].plot(np.linspace(start, stop, 1000), post2_ari(np.linspace(start, stop, 1000)), color=colors['post2'], label='All constraints')
    ...
    start = -2.25
    stop = 0.25
    ax[1,1].plot(np.linspace(start, stop, 1000), target_aci(np.linspace(start, stop, 1000)), color=colors['target'], label='Target')
    ax[1,1].plot(np.linspace(start, stop, 1000), prior_aci(np.linspace(start, stop, 1000)), color=colors['prior'], label='Prior')
    ax[1,1].plot(np.linspace(start, stop, 1000), post1_aci(np.linspace(start, stop, 1000)), color=colors['post1'], label='Temperature RMSE')
    ax[1,1].plot(np.linspace(start, stop, 1000), post2_aci(np.linspace(start, stop, 1000)), color=colors['post2'], label='All constraints')
    ...
    start = -3
    stop = 0
    ax[1,2].plot(np.linspace(start, stop, 1000), target_aer(np.linspace(start, stop, 1000)), color=colors['target'], label='Target')
    ax[1,2].plot(np.linspace(start, stop, 1000), prior_aer(np.linspace(start, stop, 1000)), color=colors['prior'], label='Prior')
    ax[1,2].plot(np.linspace(start, stop, 1000), post1_aer(np.linspace(start, stop, 1000)), color=colors['post1'], label='Temperature RMSE')
    ax[1,2].plot(np.linspace(start, stop, 1000), post2_aer(np.linspace(start, stop, 1000)), color=colors['post2'], label='All constraints')
    ...
    start = 394
    stop = 402
    ax[2,0].plot(np.linspace(start, stop, 1000), target_co2(np.linspace(start, stop, 1000)), color=colors['target'], label='Target')
    ax[2,0].plot(np.linspace(start, stop, 1000), prior_co2(np.linspace(start, stop, 1000)), color=colors['prior'], label='Prior')
    ax[2,0].plot(np.linspace(start, stop, 1000), post1_co2(np.linspace(start, stop, 1000)), color=colors['post1'], label='Temperature RMSE')
    ax[2,0].plot(np.linspace(start, stop, 1000), post2_co2(np.linspace(start, stop, 1000)), color=colors['post2'], label='All constraints')
    ...
    start = 0
    stop = 800
    ax[2,1].plot(np.linspace(start, stop), target_ohc(np.linspace(start, stop)), color=colors['target'], label='Target')
    ax[2,1].plot(np.linspace(start, stop), prior_ohc(np.linspace(start, stop)), color=colors['prior'], label='Prior')
    ax[2,1].plot(np.linspace(start, stop), post1_ohc(np.linspace(start, stop)), color=colors['post1'], label='Temperature RMSE')
    ax[2,1].plot(np.linspace(start, stop), post2_ohc(np.linspace(start, stop)), color=colors['post2'], label='All constraints')
    ax[2,1].set_xlim(start, stop)
    ax[2,1].set_ylim(0, .006)
    ...
    start = 0.8
    stop = 3.2
    ax[2,2].plot(np.linspace(start, stop, 1000), target_ssp(np.linspace(start, stop, 1000)), color=colors['target'], label='Target')
    ax[2,2].plot(np.linspace(start, stop, 1000), prior_ssp(np.linspace(start, stop, 1000)), color=colors['prior'], label='Prior')
    ax[2,2].plot(np.linspace(start, stop, 1000), post1_ssp(np.linspace(start, stop, 1000)), color=colors['post1'], label='Temperature RMSE')
    ax[2,2].plot(np.linspace(start, stop, 1000), post2_ssp(np.linspace(start, stop, 1000)), color=colors['post2'], label='All constraints')
...
print("CO2 concentration 2014:", np.percentile(draws[0]['CO2 concentration'], (5, 50, 95)))
print("Temperature 1995-2014 rel. 1850-1900:", np.percentile(draws[0]['temperature 1995-2014'], (5, 50, 95)))
print("Aerosol ERFari 2005-2014 rel. 1750:", np.percentile(draws[0]['ERFari'], (5, 50, 95)))
print("Aerosol ERFaci 2005-2014 rel. 1750:", np.percentile(draws[0]['ERFaci'], (5, 50, 95)))
print("Aerosol ERF 2005-2014 rel. 1750:", np.percentile(draws[0]['ERFaci']+draws[0]['ERFari'], (5, 50, 95)))
print("OHC change 2018 rel. 1971:", np.percentile(draws[0]['OHC'], (5, 50, 95)))
#print("ssp119 2021-2040:", np.percentile(draws[0]['ssp119 2021-2040'], (5, 50, 95)))
#print("ssp126 2021-2040:", np.percentile(draws[0]['ssp126 2021-2040'], (5, 50, 95)))
#print("ssp245 2021-2040:", np.percentile(draws[0]['ssp245 2021-2040'], (5, 50, 95)))
#print("ssp370 2021-2040:", np.percentile(draws[0]['ssp370 2021-2040'], (5, 50, 95)))
#print("ssp585 2021-2040:", np.percentile(draws[0]['ssp585 2021-2040'], (5, 50, 95)))
#print("ssp119 2041-2060:", np.percentile(draws[0]['ssp119 2041-2060'], (5, 50, 95)))
#print("ssp126 2041-2060:", np.percentile(draws[0]['ssp126 2041-2060'], (5, 50, 95)))
#print("ssp245 2041-2060:", np.percentile(draws[0]['ssp245 2041-2060'], (5, 50, 95)))
#print("ssp370 2041-2060:", np.percentile(draws[0]['ssp370 2041-2060'], (5, 50, 95)))
#print("ssp585 2041-2060:", np.percentile(draws[0]['ssp585 2041-2060'], (5, 50, 95)))
...
np.savetxt(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/posteriors/runids_rmse_reweighted_pass.csv', sorted(draws[0].index), fmt='%d')
