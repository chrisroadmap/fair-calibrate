...
df_configs = pd.read_csv(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/posteriors/calibrated_constrained_parameters.csv', index_col=0)
...
fill(
    ...
    df_configs['solar_amplitude'].values.squeeze() + 
...
if plots:
    ...
    fig.tight_layout()
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/final_ssp_temperatures.png')
    pl.show()
...
for irow in range(15):
    ...
    if scenmap==4:
        scenmap=7
    temp_model_19952014[irow, :] = (np.percentile(np.average(f.temperature[periodmap[irow%3], scenmap, :, 0], weights=weight_20yr, axis=0)-np.average(f.temperature[245:266, scenmap, :, 0], weights=weight_20yr, axis=0), (5, 50, 95)))
    temp_model_18501900[irow, :] = (np.percentile(np.average(f.temperature[periodmap[irow%3], scenmap, :, 0], weights=weight_20yr, axis=0)-np.average(f.temperature[100:152, scenmap, :, 0], weights=weight_51yr, axis=0), (5, 50, 95)))
...
print()
print("Methane forcing 2019:", np.percentile(f.forcing[269:271, 2, :, 3].mean(axis=0), (5, 50, 95)))
print("Methane concentration 2019:", np.percentile(f.concentration[269:271, 2, :, 3].mean(axis=0), (5, 50, 95)))
...
if plots:
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/ch4_ssp245.png')
    pl.close()


    pl.plot(np.arange(1750, 2021), np.percentile(f.concentration[:271, 2, :, 2], (50), axis=1), label='fair2.1 median')
    pl.plot(np.arange(1750, 2021), conc_co2['ssp245'][:271], color='k', label='SSP historical')
    pl.legend()
    pl.xlim(1750,2020)
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/co2_historical.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/ghg_forcing_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/aerosol_forcing_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/co2_forcing_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/specie54_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/specie58_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/specie59_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/specie60_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/specie61_ssp245.png')
    pl.close()
    ...
    pl.savefig(f'../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/specie62_ssp245.png')
    pl.close()
