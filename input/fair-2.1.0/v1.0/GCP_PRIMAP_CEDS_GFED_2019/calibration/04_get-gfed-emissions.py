...
# Note: GFED NOx emissions are in units of NO. I think CEDS are NO2. It looks like Zeb
# has used the output emissions from GFED without a scale factor for RCMIP. To check
# with him.
# Confirmed: email 5 Dec 2022.
...
df_out = pd.DataFrame(table, columns=range(start_year, end_year+1), index=species)
...
df_out.to_csv('../../../../../data/emissions/gfed4.1s_1997-2021.csv')
