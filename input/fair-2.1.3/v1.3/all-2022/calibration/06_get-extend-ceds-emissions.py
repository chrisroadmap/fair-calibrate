...
covid_df = pd.read_csv('../../../../../data/emissions/two_year_blip_emissions_ratios.csv', index_col=0)

for specie in species:
    ceds_df.loc[:2019, specie] = 0.001 * pd.read_csv(f'../../../../../data/emissions/ceds/v20210421/{specie}_global_CEDS_emissions_by_sector_2021_04_21.csv').sum()['X1750':].values
    ceds_df.loc[2020:2022, specie] = (
        (ceds_df.loc[2019, specie] * covid_df.loc[2020:2022, rcmip_specie[specie]])
    )
    
ceds_df.to_csv(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/emissions/ceds_emissions_extended_1750-2022.csv')
