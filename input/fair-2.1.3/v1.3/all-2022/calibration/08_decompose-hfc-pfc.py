...
gases.drop(columns=["2024", "2025", "2026", "2027", "2028", "2029", "2030"], inplace=True)
...
hfc_rcmip_total = gases_gwp100ar6.loc[gases_gwp100ar6.index.str.contains(r"\|HFC\|"), :].sum()
pfc_rcmip_total = gases_gwp100ar6.loc[gases_gwp100ar6.index.str.contains(r"\|PFC\|"), :].sum()
...
hfcs_decomposed = gases.loc[gases.index.str.contains(r"\|HFC\|"), '1750':'2022'] * scale_hfc_total
pfcs_decomposed = gases.loc[gases.index.str.contains(r"\|PFC\|"), '1750':'2022'] * scale_pfc_total
...
df_out.to_csv(f'../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/emissions/hfcs_pfcs_split_1750-2022.csv')
