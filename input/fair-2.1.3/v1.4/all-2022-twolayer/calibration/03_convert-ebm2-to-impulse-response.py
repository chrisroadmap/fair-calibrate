...
# This notebook takes the two-layer energy balance model tunings from Donald Cummins
# and converts them to a two-layer impulse response function.
#
...
df_out.to_csv(
    f"../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/calibrations/"
    "4xCO2_impulse_response_ebm2_cmip6.csv",
    index=False,
)
