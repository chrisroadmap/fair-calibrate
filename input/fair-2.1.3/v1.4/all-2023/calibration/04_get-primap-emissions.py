...
# Here, we use v2.5.1 of PRIMAP. We use Third Party emissions.
...
primap25 = pooch.retrieve(
    url="https://zenodo.org/records/10705513/files/"
    "Guetschow_et_al_2024-PRIMAP-hist_v2.5.1_final_no_rounding_27-Feb-2024.csv",
    known_hash="md5:5060d8af9afe3bc4d1d4cede13449dee",
...
for scenario in ["HISTTP"]:
    ...
    df_out.to_csv(
        f"../../../../../output/fair-{fair_v}/v{cal_v}/{constraint_set}/emissions/"
        f"primap-{scenario.lower()}-2.5.1_1750-2022.csv"
    )
