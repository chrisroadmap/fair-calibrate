...
# trapezoid distribution [-2.2, -1.6, -1.0, -0.4, +0.2]
...
df_emis_obs = pd.read_csv(
    "../../../../../data/emissions/"
    "CH4Pledge-rcmip-emissions-ssp245-CLE-MFR-filled.csv",
)

# overwrite RCMIP
so2 = df_emis_obs.loc[
    (df_emis_obs["scenario"] == "MESSAGE-GLOBIOM___SSP2-45-CLE-CH4")
    & (df_emis_obs["variable"] == "Sulfur")
    & (df_emis_obs["region"] == "World"),
    "1750.5":"2100.5",
].interpolate(axis=1).values.squeeze()

bc = df_emis_obs.loc[
    (df_emis_obs["scenario"] == "MESSAGE-GLOBIOM___SSP2-45-CLE-CH4")
    & (df_emis_obs["variable"] == "BC")
    & (df_emis_obs["region"] == "World"),
    "1750.5":"2100.5",
].interpolate(axis=1).values.squeeze()
