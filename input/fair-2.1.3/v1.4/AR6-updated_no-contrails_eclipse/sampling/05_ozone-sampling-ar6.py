...
df_emis = pd.read_csv("../../../../../data/emissions/CH4Pledge-rcmip-emissions-ssp245-CLE-MFR-filled.csv")
...
if plots:
    ...
    pl.plot(np.arange(1750.5, 2020), forcing, label="best estimate fit", color="0.5")
