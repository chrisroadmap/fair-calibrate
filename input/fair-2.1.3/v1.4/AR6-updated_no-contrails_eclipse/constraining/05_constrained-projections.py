...
da = da_emissions.loc[dict(config="unspecified")]
...
# correct LAPSI scale factor terms
fill(
...
fancy_titles = {
    "MESSAGE-GLOBIOM___SSP2-45-CLE-CH4": "CLE",
    "MESSAGE-GLOBIOM___SSP2-45-MFR-CH4": "MFR",
    "MESSAGE-GLOBIOM___SSP2-45": "SSP2-4.5",
}

ar6_colors = {
    "MESSAGE-GLOBIOM___SSP2-45-MFR-CH4": "#00a9cf",
    "MESSAGE-GLOBIOM___SSP2-45": "#f69320",
    "MESSAGE-GLOBIOM___SSP2-45-CLE-CH4": "#980002",
}
...
temp_model_19952014 = np.zeros((9, 3))
temp_model_18501900 = np.zeros((9, 3))
...
if plots:
    ...
    pl.fill_between(
        np.arange(1750, 2102),
        np.percentile(
            f.forcing[:, 2, :, 2:5].sum(axis=2)
            + f.forcing[:, 2, :, 12:53].sum(axis=2),
            5,
            axis=1,
        ),
        np.percentile(
