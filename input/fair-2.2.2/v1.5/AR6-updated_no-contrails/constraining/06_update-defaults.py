...
# a hack is just to update baseline emission for CH4 and N2O
# the rest is as given in RCMIP
if update_baselines:
    df_species_configs.loc['CH4', 'baseline_emissions'] = 19.019783117809567
    df_species_configs.loc['N2O', 'baseline_emissions'] = 0.08602230754
