...
# We multiply the N2O and C6F14 emissions by their scale factors previously calculated.

# We don't have future projections from NOx aviation, so we drop it.

# 2022 is the last year where all emissions are available so we harmonize to this.
...
# Harmonization overrides - use same as AR6 WG3 database
