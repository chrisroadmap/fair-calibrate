...
# overwrite RCMIP
so2 = df_emis_obs.loc[df_emis_obs["variable"] == "Sulfur", '1750':'2024'].values.squeeze()
bc = df_emis_obs.loc[df_emis_obs["variable"] == "BC", '1750':'2024'].values.squeeze()
oc = df_emis_obs.loc[df_emis_obs["variable"] == "OC", '1750':'2024'].values.squeeze()
