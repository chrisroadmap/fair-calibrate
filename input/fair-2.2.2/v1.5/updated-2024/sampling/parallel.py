...
def run_fair(cfg):
    ...
    da = da_emissions.loc[dict(config="unspecified", scenario="ssp245")][:275, ...]
    ...
    fill(f.species_configs["baseline_emissions"], 26.6237352006621, specie="CH4")
    fill(f.species_configs["baseline_emissions"], 19.1961825967504, specie="NOx")
    fill(f.species_configs["baseline_emissions"], 2.29755041140102, specie="Sulfur")
    fill(f.species_configs["baseline_emissions"], 341.276039272199, specie="CO")
    fill(f.species_configs["baseline_emissions"], 59.4210248601049, specie="VOC")
    fill(f.species_configs["baseline_emissions"], 2.08148799298139, specie="BC")
    fill(f.species_configs["baseline_emissions"], 15.5693631960849, specie="OC")
    fill(f.species_configs["baseline_emissions"], 6.61639973308915, specie="NH3")
    fill(f.species_configs["baseline_emissions"], 0.999086659065712, specie="N2O")
    fill(f.species_configs["baseline_emissions"], 261.032537770688, specie="CHCl3")
    fill(f.species_configs["baseline_emissions"], 215.973197070249, specie="CH2Cl2")
    fill(f.species_configs["baseline_emissions"], 4554.41561476352, specie="CH3Cl")
    fill(f.species_configs["baseline_emissions"], 111.765970760955, specie="CH3Br")
    fill(f.species_configs["baseline_emissions"], 0.0144531295608124, specie="CF4")
    ...
    return (
        ...
        f.concentration[274:276, 0, :, 2].mean(axis=0),
        np.average(
