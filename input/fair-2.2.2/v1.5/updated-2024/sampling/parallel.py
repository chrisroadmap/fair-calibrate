...
def run_fair(cfg):
    ...
    fill(f.species_configs["baseline_emissions"], 40.66922288, specie="CH4")
    fill(f.species_configs["baseline_emissions"], 19.44370599, specie="NOx")
    fill(f.species_configs["baseline_emissions"], 2.350436138, specie="Sulfur")
    fill(f.species_configs["baseline_emissions"], 348.8382647, specie="CO")
    fill(f.species_configs["baseline_emissions"], 60.93160287, specie="VOC")
    ...
    fill(f.species_configs["baseline_emissions"], 0.010653464, specie="CF4")
