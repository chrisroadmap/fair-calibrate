...
def run_fair(cfg):
    ...
    return (
        np.array((f.temperature[70, 0, :, 0], f.temperature[140, 0, :, 0], f.temperature[210, 0, :, 0])),
        np.array((f.airborne_fraction[70, 0, :, 0], f.airborne_fraction[140, 0, :, 0], f.airborne_fraction[210, 0, :, 0])),
        np.array(t1000),
    )
