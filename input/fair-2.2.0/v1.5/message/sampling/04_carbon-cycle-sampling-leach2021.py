...
# IN THIS VERSION ONLY: SCALE DOWN r0, rA and rU BY 0.86
...
# NB1: rU and rA are in GtC units in Nick's paper, we need to convert to GtCO2
# NB2: should scale down rC and rA by 0.86, since the cumulative historical emissions in MESSAGE are 
# 1/0.86 times as high as in RCMIP
data = np.array(
    [
        [
            36.73854601035055,
...
data[0, :] = data[0, :] * 0.86
data[1, :] = data[1, :] * compound_convert["CO2"]["C"] * 0.86
data[3, :] = data[3, :] * compound_convert["CO2"]["C"] * 0.86
