...
if plots:
    ...
    pl.savefig(
        f"../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_temperature.png"
    )
    pl.savefig(
        f"../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/prior_temperature.pdf"
    )
    pl.close()
...
if plots:
    ...
    pl.savefig(
        ...
        "post_rsme_top10_bottom10_temperature.png"
    )
    pl.savefig(
        f"../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/"
        "post_rsme_top10_bottom10_temperature.pdf"
    )
    pl.close()
    ...
    pl.savefig(
        f"../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/"
        "post_rsme_temperature.png"
    )
    pl.savefig(
        f"../../../../../plots/fair-{fair_v}/v{cal_v}/{constraint_set}/"
        "post_rsme_temperature.pdf"
    )
    pl.close()
