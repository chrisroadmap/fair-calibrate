...
species_ids = {
    ...
    "aerosol-cloud interactions": SpeciesID(
        "Aerosol-Cloud Interactions", Category.AEROSOL_CLOUD_INTERACTIONS
    ),
...
for imodel, model in enumerate(models):
    for run in df.loc[df["model"] == model, "run"]:
        ...
        species_config = [
            species_config_from_default(species) for species in species_to_include
        ]
