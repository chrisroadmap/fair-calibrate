...
for iscen, scenario in enumerate(scenarios_to_include):
    ...
    for ispec, species in enumerate(scenario_species):
        ...
        list_of_species.append(
            Species(species_ids[species.lower()], concentration=conc_in)
        )
        ...
        species_config = [
            SpeciesConfig(
                species_id=SpeciesID(
                    name="CO2", category=Category.CO2, run_mode=RunMode.CONCENTRATION
                ),
            ...
            SpeciesConfig(
                species_id=SpeciesID(
                    "CH4", Category.CH4, run_mode=RunMode.CONCENTRATION
                ),
            ...
            SpeciesConfig(
                species_id=SpeciesID(
                    "N2O", Category.N2O, run_mode=RunMode.CONCENTRATION
                ),
