...
def test_ssp_emissions_cmip6_ebm3_calibrations():
    ...
    df = pd.read_csv(os.path.join(HERE, "..", "data", "calibration", "4xCO2_cummins_ebm3.csv"))
    ...
    df_volcanic = pd.read_csv(os.path.join(HERE, "..", "data", "forcing", "volcanic_ERF_monthly_-950001-201912.csv"), index_col='year')
    ...
    #f.temperature[-1,...,0].to_netcdf(os.path.join(HERE, "test_data", "cmip6_ssp_emissions_run_temperature_2100.nc"))
    #f.concentration[-1,...,2].to_netcdf(os.path.join(HERE, "test_data", "cmip6_ssp_emissions_run_co2_concentration_2100.nc"))
    #f.forcing_sum[-1,...].to_netcdf(os.path.join(HERE, "test_data", "cmip6_ssp_emissions_run_forcing_sum_2100.nc"))

    expected_temperature = xr.open_dataarray(os.path.join(HERE, "test_data", "cmip6_ssp_emissions_run_temperature_2100.nc"))
    expected_co2_concentration = xr.open_dataarray(os.path.join(HERE, "test_data", "cmip6_ssp_emissions_run_co2_concentration_2100.nc"))
    expected_forcing_sum = xr.open_dataarray(os.path.join(HERE, "test_data", "cmip6_ssp_emissions_run_forcing_sum_2100.nc"))
